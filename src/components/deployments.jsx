    ...
    <div className="flex justify-center mt-16 w-full mb-16">
      {deployments.length > 0 ? (
        <Card>
          <CardHeader>
            <div className="flex justify-between">
              ...
              <div>
                <Button onClick={fetchDeployments} variant="secondary">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold mb-1">No deployments yet</h1>
          <p className="text-gray-400">Deploy your first app now</p>
        </div>
      )}
    </div>
  );
